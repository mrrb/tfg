...
def print_help(name):
    ...
    print("Options: ",
          " -b: Print the minimal divider value for a given clock (arg1) and Serial baudrate (arg2). [Default]",
...
if __name__ == "__main__":
    ...
    name  = arg.pop(0)
    l     = len(arg)
    modes = {'b':False, 'd':False, 't':False, 'c':False} # b -> Print the minimal divider value [clk, baudrate];
