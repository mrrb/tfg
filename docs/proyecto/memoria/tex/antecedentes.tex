...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=140mm]{analizadores_software/wireshark.png}
...
\begin{itemize}
    ...
    \begin{figure}[hbtp]
        \centering
        \includegraphics[width=92.5mm]{analizadores_hardware/Ultra-Embedded.jpg}
...
Se aprecia que dentro de este grupo, el equipo más recomendable a razón de sun funcionalidades ofrecidas y precio es el \emph{Mercury T2} de \emph{Teledyne LeCroy}. Si se buscan más funcionalidades y almacenamiento, es más viable utilizar el  {\emph{Beagle USB 480 Power} de \emph{Total Phase}.

El sistema de \emph{Ultra-Embedded} está al nivel de las ediciones más económicas de equipos comerciales. Por lo que si no se buscan funcionalidades extras, posee una excelente relación calidad-precio.
