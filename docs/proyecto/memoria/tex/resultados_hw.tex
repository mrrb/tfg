...
Estos $bytes$, tras ser recibidos por el módulo de comunicación serie, son recogidos por este módulo, el cual los clasifica y almacena hasta su ejecución. En el listado~\ref{src:resultados-modulos-ulpi-op} se plasman los parámetros, entradas y salidas del módulo.
...
% \noWord[Borrar figura, no la termines, no es útil.]
% \begin{figure}[!hbt]
%     \centering
